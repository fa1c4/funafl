...
#define COV_CHECK_TIME 3600 // 60s for local test. Formally set 3600 seconds (1 hour per check)
#define INTERVAL_MILLISECONDS COV_CHECK_TIME * 1000 // seconds * 1000 -> milliseconds
